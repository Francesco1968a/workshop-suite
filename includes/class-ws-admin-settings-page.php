            ...
            <?php elseif ($tab === 'shortcodes') : ?>
                <div class="ws-card-native">
                    ...
                    $shortcodes = [
                        ...
                        ['tag' => '[ws_workshop_text slug="..." field="intro"]', 'alias' => null, 'title' => 'Blocco di testo Categoria (singolo)', 'desc' => 'Incorpora un solo blocco (field: intro, program, requirements, important_notes) per comporre una pagina su misura invece della [ws_workshop_page] completa.', 'badge' => 'Pubblico'],
