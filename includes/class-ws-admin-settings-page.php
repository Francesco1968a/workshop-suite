            ...
            <?php elseif ($tab === 'shortcodes') : ?>
                <div class="ws-card-native">
                    ...
                    $shortcodes = [
                        ...
                        ['tag' => '[eventi_categoria slug="..."]', 'alias' => null, 'title' => 'Griglia Eventi per Categoria', 'desc' => 'Visualizza l\'elenco di tutti gli eventi associati ad una specifica categoria. Già incluso in [wsma_workshop_page], usalo da solo solo se componi la pagina a mano.', 'badge' => 'Pubblico'],
